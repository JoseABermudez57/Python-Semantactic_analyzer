...
_lr_productions = [
  ...
  ('PROGRAM -> BLOCK_CODE','PROGRAM',1,'p_PROGRAM','syntactic_analyzer.py',98),
  ('BLOCK_CODE -> GV','BLOCK_CODE',1,'p_BLOCK_CODE','syntactic_analyzer.py',105),
  ('BLOCK_CODE -> GC','BLOCK_CODE',1,'p_BLOCK_CODE','syntactic_analyzer.py',106),
  ('BLOCK_CODE -> GF','BLOCK_CODE',1,'p_BLOCK_CODE','syntactic_analyzer.py',107),
  ('BLOCK_CODE -> GCF','BLOCK_CODE',1,'p_BLOCK_CODE','syntactic_analyzer.py',108),
  ('BLOCK_CODE -> EMPTY','BLOCK_CODE',1,'p_BLOCK_CODE','syntactic_analyzer.py',109),
  ('C -> GV','C',1,'p_C','syntactic_analyzer.py',120),
  ('C -> GC','C',1,'p_C','syntactic_analyzer.py',121),
  ('C -> GCF','C',1,'p_C','syntactic_analyzer.py',122),
  ('C -> EMPTY','C',1,'p_C','syntactic_analyzer.py',123),
  ('GV -> TD V I VA BLOCK_CODE','GV',5,'p_GV','syntactic_analyzer.py',160),
  ('GV -> TD V BLOCK_CODE','GV',3,'p_GV','syntactic_analyzer.py',161),
  ('GV -> EMPTY','GV',1,'p_GV','syntactic_analyzer.py',162),
  ('TD -> INTEGER_TYPE','TD',1,'p_TD','syntactic_analyzer.py',179),
  ('TD -> BOOLEAN_TYPE','TD',1,'p_TD','syntactic_analyzer.py',180),
  ('TD -> DECIMAL_TYPE','TD',1,'p_TD','syntactic_analyzer.py',181),
  ('TD -> STRING_TYPE','TD',1,'p_TD','syntactic_analyzer.py',182),
  ('V -> VARIABLE','V',1,'p_V','syntactic_analyzer.py',190),
  ('I -> ASSIGNMENT','I',1,'p_I','syntactic_analyzer.py',198),
  ('VA -> NUMBER','VA',1,'p_VA','syntactic_analyzer.py',206),
  ('VA -> NUMBER DOT NUMBER','VA',3,'p_VA','syntactic_analyzer.py',207),
  ('VA -> TRUE_VALUE','VA',1,'p_VA','syntactic_analyzer.py',208),
  ('VA -> FALSE_VALUE','VA',1,'p_VA','syntactic_analyzer.py',209),
  ('VA -> QUOTATION_MARKS V QUOTATION_MARKS','VA',3,'p_VA','syntactic_analyzer.py',210),
  ('GC -> CN PA CD PC MY C MN BLOCK_CODE','GC',8,'p_GC','syntactic_analyzer.py',223),
  ('GC -> CN PA CD PC MY MN BLOCK_CODE','GC',7,'p_GC','syntactic_analyzer.py',224),
  ('GC -> EMPTY','GC',1,'p_GC','syntactic_analyzer.py',225),
  ('CN -> IF','CN',1,'p_CN','syntactic_analyzer.py',238),
  ('CD -> V S V','CD',3,'p_CD','syntactic_analyzer.py',246),
  ('CD -> V S VA','CD',3,'p_CD','syntactic_analyzer.py',247),
  ('CD -> VA S V','CD',3,'p_CD','syntactic_analyzer.py',248),
  ('CD -> VA S VA','CD',3,'p_CD','syntactic_analyzer.py',249),
  ('S -> EQUAL','S',1,'p_S','syntactic_analyzer.py',257),
  ('S -> GREATER_THAN','S',1,'p_S','syntactic_analyzer.py',258),
  ('S -> LESS_THAN','S',1,'p_S','syntactic_analyzer.py',259),
  ('S -> GREATER_OR_EQUAL','S',1,'p_S','syntactic_analyzer.py',260),
  ('S -> LESS_OR_EQUAL','S',1,'p_S','syntactic_analyzer.py',261),
  ('S -> NOT_EQUAL','S',1,'p_S','syntactic_analyzer.py',262),
  ('GF -> TD V ME PR MA MY C RT MN BLOCK_CODE','GF',10,'p_GF','syntactic_analyzer.py',270),
  ('GF -> V ME PR MA MY C MN BLOCK_CODE','GF',8,'p_GF','syntactic_analyzer.py',271),
  ('GF -> TD V ME PR MA MY RT MN BLOCK_CODE','GF',9,'p_GF','syntactic_analyzer.py',272),
  ('GF -> V ME PR MA MY MN BLOCK_CODE','GF',7,'p_GF','syntactic_analyzer.py',273),
  ('GF -> TD V ME MA MY C RT MN BLOCK_CODE','GF',9,'p_GF','syntactic_analyzer.py',274),
  ('GF -> V ME MA MY C MN BLOCK_CODE','GF',7,'p_GF','syntactic_analyzer.py',275),
  ('GF -> TD V ME MA MY RT MN BLOCK_CODE','GF',8,'p_GF','syntactic_analyzer.py',276),
  ('GF -> V ME MA MY MN BLOCK_CODE','GF',6,'p_GF','syntactic_analyzer.py',277),
  ('GF -> EMPTY','GF',1,'p_GF','syntactic_analyzer.py',278),
  ('PR -> V','PR',1,'p_PR','syntactic_analyzer.py',297),
  ('ME -> LESS_THAN','ME',1,'p_ME','syntactic_analyzer.py',305),
  ('MA -> GREATER_THAN','MA',1,'p_MA','syntactic_analyzer.py',313),
  ('RT -> RETURN V','RT',2,'p_RT','syntactic_analyzer.py',321),
  ('GCF -> F PA CDF PC MY C MN BLOCK_CODE','GCF',8,'p_GCF','syntactic_analyzer.py',329),
  ('GCF -> F PA CDF PC MY MN BLOCK_CODE','GCF',7,'p_GCF','syntactic_analyzer.py',330),
  ('GCF -> EMPTY','GCF',1,'p_GCF','syntactic_analyzer.py',331),
  ('F -> FOR','F',1,'p_F','syntactic_analyzer.py',344),
  ('CDF -> NUMBER SE NUMBER SE O','CDF',5,'p_CDF','syntactic_analyzer.py',352),
  ('SE -> PIPE','SE',1,'p_PIPE','syntactic_analyzer.py',360),
  ('O -> SUBTRACTION','O',1,'p_O','syntactic_analyzer.py',368),
  ('O -> ADDITION','O',1,'p_O','syntactic_analyzer.py',369),
  ('PA -> PARENTHESIS_OPEN','PA',1,'p_PA','syntactic_analyzer.py',380),
  ('PC -> PARENTHESIS_CLOSE','PC',1,'p_PC','syntactic_analyzer.py',388),
  ('MY -> OPEN_BODY','MY',1,'p_MY','syntactic_analyzer.py',396),
  ('MN -> LESS_OR_EQUAL','MN',1,'p_MN','syntactic_analyzer.py',404),
  ('EMPTY -> <empty>','EMPTY',0,'p_empty','syntactic_analyzer.py',411),
]
