...
_lr_productions = [
  ...
  ('C -> EMPTY','C',1,'p_C','syntactic_analyzer.py',127),
  ('GV -> TD V I VA BLOCK_CODE','GV',5,'p_GV','syntactic_analyzer.py',166),
  ('GV -> TD V BLOCK_CODE','GV',3,'p_GV','syntactic_analyzer.py',167),
  ('GV -> EMPTY','GV',1,'p_GV','syntactic_analyzer.py',168),
  ('TD -> INTEGER_TYPE','TD',1,'p_TD','syntactic_analyzer.py',183),
  ('TD -> BOOLEAN_TYPE','TD',1,'p_TD','syntactic_analyzer.py',184),
  ('TD -> DECIMAL_TYPE','TD',1,'p_TD','syntactic_analyzer.py',185),
  ('TD -> STRING_TYPE','TD',1,'p_TD','syntactic_analyzer.py',186),
  ('V -> VARIABLE','V',1,'p_V','syntactic_analyzer.py',194),
  ('I -> ASSIGNMENT','I',1,'p_I','syntactic_analyzer.py',202),
  ('VA -> NUMBER','VA',1,'p_VA','syntactic_analyzer.py',210),
  ('VA -> NUMBER DOT NUMBER','VA',3,'p_VA','syntactic_analyzer.py',211),
  ('VA -> TRUE_VALUE','VA',1,'p_VA','syntactic_analyzer.py',212),
  ('VA -> FALSE_VALUE','VA',1,'p_VA','syntactic_analyzer.py',213),
  ('VA -> QUOTATION_MARKS V QUOTATION_MARKS','VA',3,'p_VA','syntactic_analyzer.py',214),
  ('GC -> CN PA CD PC MY C MN BLOCK_CODE','GC',8,'p_GC','syntactic_analyzer.py',225),
  ('GC -> CN PA CD PC MY MN BLOCK_CODE','GC',7,'p_GC','syntactic_analyzer.py',226),
  ('GC -> EMPTY','GC',1,'p_GC','syntactic_analyzer.py',227),
  ('CN -> IF','CN',1,'p_CN','syntactic_analyzer.py',240),
  ('CD -> V S V','CD',3,'p_CD','syntactic_analyzer.py',352),
  ('CD -> V S VA','CD',3,'p_CD','syntactic_analyzer.py',353),
  ('CD -> VA S V','CD',3,'p_CD','syntactic_analyzer.py',354),
  ('CD -> VA S VA','CD',3,'p_CD','syntactic_analyzer.py',355),
  ('S -> EQUAL','S',1,'p_S','syntactic_analyzer.py',366),
  ('S -> GREATER_THAN','S',1,'p_S','syntactic_analyzer.py',367),
  ('S -> LESS_THAN','S',1,'p_S','syntactic_analyzer.py',368),
  ('S -> GREATER_OR_EQUAL','S',1,'p_S','syntactic_analyzer.py',369),
  ('S -> LESS_OR_EQUAL','S',1,'p_S','syntactic_analyzer.py',370),
  ('S -> NOT_EQUAL','S',1,'p_S','syntactic_analyzer.py',371),
  ('GF -> TD V ME PR MA MY C RT MN BLOCK_CODE','GF',10,'p_GF','syntactic_analyzer.py',379),
  ('GF -> V ME PR MA MY C MN BLOCK_CODE','GF',8,'p_GF','syntactic_analyzer.py',380),
  ('GF -> TD V ME PR MA MY RT MN BLOCK_CODE','GF',9,'p_GF','syntactic_analyzer.py',381),
  ('GF -> V ME PR MA MY MN BLOCK_CODE','GF',7,'p_GF','syntactic_analyzer.py',382),
  ('GF -> TD V ME MA MY C RT MN BLOCK_CODE','GF',9,'p_GF','syntactic_analyzer.py',383),
  ('GF -> V ME MA MY C MN BLOCK_CODE','GF',7,'p_GF','syntactic_analyzer.py',384),
  ('GF -> TD V ME MA MY RT MN BLOCK_CODE','GF',8,'p_GF','syntactic_analyzer.py',385),
  ('GF -> V ME MA MY MN BLOCK_CODE','GF',6,'p_GF','syntactic_analyzer.py',386),
  ('GF -> EMPTY','GF',1,'p_GF','syntactic_analyzer.py',387),
  ('PR -> V','PR',1,'p_PR','syntactic_analyzer.py',406),
  ('ME -> LESS_THAN','ME',1,'p_ME','syntactic_analyzer.py',414),
  ('MA -> GREATER_THAN','MA',1,'p_MA','syntactic_analyzer.py',422),
  ('RT -> RETURN V','RT',2,'p_RT','syntactic_analyzer.py',430),
  ('GCF -> F PA CDF PC MY C MN BLOCK_CODE','GCF',8,'p_GCF','syntactic_analyzer.py',438),
  ('GCF -> F PA CDF PC MY MN BLOCK_CODE','GCF',7,'p_GCF','syntactic_analyzer.py',439),
  ('GCF -> EMPTY','GCF',1,'p_GCF','syntactic_analyzer.py',440),
  ('F -> FOR','F',1,'p_F','syntactic_analyzer.py',453),
  ('CDF -> NUMBER SE NUMBER SE O','CDF',5,'p_CDF','syntactic_analyzer.py',461),
  ('SE -> PIPE','SE',1,'p_PIPE','syntactic_analyzer.py',469),
  ('O -> SUBTRACTION','O',1,'p_O','syntactic_analyzer.py',477),
  ('O -> ADDITION','O',1,'p_O','syntactic_analyzer.py',478),
  ('PA -> PARENTHESIS_OPEN','PA',1,'p_PA','syntactic_analyzer.py',489),
  ('PC -> PARENTHESIS_CLOSE','PC',1,'p_PC','syntactic_analyzer.py',497),
  ('MY -> OPEN_BODY','MY',1,'p_MY','syntactic_analyzer.py',505),
  ('MN -> LESS_OR_EQUAL','MN',1,'p_MN','syntactic_analyzer.py',513),
  ('EMPTY -> <empty>','EMPTY',0,'p_EMPTY','syntactic_analyzer.py',520),
]
