...
_lr_productions = [
  ...
  ('PROGRAM -> BLOCK_CODE','PROGRAM',1,'p_PROGRAM','syntactic_analyzer.py',95),
  ('BLOCK_CODE -> GV','BLOCK_CODE',1,'p_BLOCK_CODE','syntactic_analyzer.py',102),
  ('BLOCK_CODE -> GC','BLOCK_CODE',1,'p_BLOCK_CODE','syntactic_analyzer.py',103),
  ('BLOCK_CODE -> GF','BLOCK_CODE',1,'p_BLOCK_CODE','syntactic_analyzer.py',104),
  ('BLOCK_CODE -> GCF','BLOCK_CODE',1,'p_BLOCK_CODE','syntactic_analyzer.py',105),
  ('BLOCK_CODE -> EMPTY','BLOCK_CODE',1,'p_BLOCK_CODE','syntactic_analyzer.py',106),
  ('C -> GV','C',1,'p_C','syntactic_analyzer.py',117),
  ('C -> GC','C',1,'p_C','syntactic_analyzer.py',118),
  ('C -> GCF','C',1,'p_C','syntactic_analyzer.py',119),
  ('C -> EMPTY','C',1,'p_C','syntactic_analyzer.py',120),
  ('GV -> TD V I VA BLOCK_CODE','GV',5,'p_GV','syntactic_analyzer.py',131),
  ('GV -> TD V BLOCK_CODE','GV',3,'p_GV','syntactic_analyzer.py',132),
  ('GV -> EMPTY','GV',1,'p_GV','syntactic_analyzer.py',133),
  ('TD -> INTEGER_TYPE','TD',1,'p_TD','syntactic_analyzer.py',152),
  ('TD -> BOOLEAN_TYPE','TD',1,'p_TD','syntactic_analyzer.py',153),
  ('TD -> DECIMAL_TYPE','TD',1,'p_TD','syntactic_analyzer.py',154),
  ('TD -> STRING_TYPE','TD',1,'p_TD','syntactic_analyzer.py',155),
  ('V -> VARIABLE','V',1,'p_V','syntactic_analyzer.py',163),
  ('I -> ASSIGNMENT','I',1,'p_I','syntactic_analyzer.py',171),
  ('VA -> NUMBER','VA',1,'p_VA','syntactic_analyzer.py',179),
  ('VA -> NUMBER DOT NUMBER','VA',3,'p_VA','syntactic_analyzer.py',180),
  ('VA -> TRUE_VALUE','VA',1,'p_VA','syntactic_analyzer.py',181),
  ('VA -> FALSE_VALUE','VA',1,'p_VA','syntactic_analyzer.py',182),
  ('VA -> QUOTATION_MARKS V QUOTATION_MARKS','VA',3,'p_VA','syntactic_analyzer.py',183),
  ('GC -> CN PA CD PC MY C MN BLOCK_CODE','GC',8,'p_GC','syntactic_analyzer.py',194),
  ('GC -> CN PA CD PC MY MN BLOCK_CODE','GC',7,'p_GC','syntactic_analyzer.py',195),
  ('GC -> EMPTY','GC',1,'p_GC','syntactic_analyzer.py',196),
  ('CN -> IF','CN',1,'p_CN','syntactic_analyzer.py',209),
  ('CD -> V S V','CD',3,'p_CD','syntactic_analyzer.py',217),
  ('CD -> V S VA','CD',3,'p_CD','syntactic_analyzer.py',218),
  ('CD -> VA S V','CD',3,'p_CD','syntactic_analyzer.py',219),
  ('CD -> VA S VA','CD',3,'p_CD','syntactic_analyzer.py',220),
  ('S -> EQUAL','S',1,'p_S','syntactic_analyzer.py',228),
  ('S -> GREATER_THAN','S',1,'p_S','syntactic_analyzer.py',229),
  ('S -> LESS_THAN','S',1,'p_S','syntactic_analyzer.py',230),
  ('S -> GREATER_OR_EQUAL','S',1,'p_S','syntactic_analyzer.py',231),
  ('S -> LESS_OR_EQUAL','S',1,'p_S','syntactic_analyzer.py',232),
  ('S -> NOT_EQUAL','S',1,'p_S','syntactic_analyzer.py',233),
  ('GF -> TD V ME PR MA MY C RT MN BLOCK_CODE','GF',10,'p_GF','syntactic_analyzer.py',241),
  ('GF -> V ME PR MA MY C MN BLOCK_CODE','GF',8,'p_GF','syntactic_analyzer.py',242),
  ('GF -> TD V ME PR MA MY RT MN BLOCK_CODE','GF',9,'p_GF','syntactic_analyzer.py',243),
  ('GF -> V ME PR MA MY MN BLOCK_CODE','GF',7,'p_GF','syntactic_analyzer.py',244),
  ('GF -> TD V ME MA MY C RT MN BLOCK_CODE','GF',9,'p_GF','syntactic_analyzer.py',245),
  ('GF -> V ME MA MY C MN BLOCK_CODE','GF',7,'p_GF','syntactic_analyzer.py',246),
  ('GF -> TD V ME MA MY RT MN BLOCK_CODE','GF',8,'p_GF','syntactic_analyzer.py',247),
  ('GF -> V ME MA MY MN BLOCK_CODE','GF',6,'p_GF','syntactic_analyzer.py',248),
  ('GF -> EMPTY','GF',1,'p_GF','syntactic_analyzer.py',249),
  ('PR -> V','PR',1,'p_PR','syntactic_analyzer.py',277),
  ('ME -> LESS_THAN','ME',1,'p_ME','syntactic_analyzer.py',285),
  ('MA -> GREATER_THAN','MA',1,'p_MA','syntactic_analyzer.py',293),
  ('RT -> RETURN V','RT',2,'p_RT','syntactic_analyzer.py',301),
  ('GCF -> F PA CDF PC MY C MN BLOCK_CODE','GCF',8,'p_GCF','syntactic_analyzer.py',309),
  ('GCF -> F PA CDF PC MY MN BLOCK_CODE','GCF',7,'p_GCF','syntactic_analyzer.py',310),
  ('GCF -> EMPTY','GCF',1,'p_GCF','syntactic_analyzer.py',311),
  ('F -> FOR','F',1,'p_F','syntactic_analyzer.py',324),
  ('CDF -> NUMBER SE NUMBER SE O','CDF',5,'p_CDF','syntactic_analyzer.py',332),
  ('SE -> PIPE','SE',1,'p_PIPE','syntactic_analyzer.py',340),
  ('O -> SUBTRACTION','O',1,'p_O','syntactic_analyzer.py',348),
  ('O -> ADDITION','O',1,'p_O','syntactic_analyzer.py',349),
  ('PA -> PARENTHESIS_OPEN','PA',1,'p_PA','syntactic_analyzer.py',360),
  ('PC -> PARENTHESIS_CLOSE','PC',1,'p_PC','syntactic_analyzer.py',368),
  ('MY -> OPEN_BODY','MY',1,'p_MY','syntactic_analyzer.py',376),
  ('MN -> LESS_OR_EQUAL','MN',1,'p_MN','syntactic_analyzer.py',384),
  ('EMPTY -> <empty>','EMPTY',0,'p_empty','syntactic_analyzer.py',391),
]
