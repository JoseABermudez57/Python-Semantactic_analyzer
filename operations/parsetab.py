...
_lr_productions = [
  ...
  ('TD -> INTEGER_TYPE','TD',1,'p_TD','syntactic_analyzer.py',149),
  ('TD -> BOOLEAN_TYPE','TD',1,'p_TD','syntactic_analyzer.py',150),
  ('TD -> DECIMAL_TYPE','TD',1,'p_TD','syntactic_analyzer.py',151),
  ('TD -> STRING_TYPE','TD',1,'p_TD','syntactic_analyzer.py',152),
  ('V -> VARIABLE','V',1,'p_V','syntactic_analyzer.py',160),
  ('I -> ASSIGNMENT','I',1,'p_I','syntactic_analyzer.py',168),
  ('VA -> NUMBER','VA',1,'p_VA','syntactic_analyzer.py',176),
  ('VA -> NUMBER DOT NUMBER','VA',3,'p_VA','syntactic_analyzer.py',177),
  ('VA -> TRUE_VALUE','VA',1,'p_VA','syntactic_analyzer.py',178),
  ('VA -> FALSE_VALUE','VA',1,'p_VA','syntactic_analyzer.py',179),
  ('VA -> QUOTATION_MARKS V QUOTATION_MARKS','VA',3,'p_VA','syntactic_analyzer.py',180),
  ('GC -> CN PA CD PC MY C MN BLOCK_CODE','GC',8,'p_GC','syntactic_analyzer.py',191),
  ('GC -> CN PA CD PC MY MN BLOCK_CODE','GC',7,'p_GC','syntactic_analyzer.py',192),
  ('GC -> EMPTY','GC',1,'p_GC','syntactic_analyzer.py',193),
  ('CN -> IF','CN',1,'p_CN','syntactic_analyzer.py',206),
  ('CD -> V S V','CD',3,'p_CD','syntactic_analyzer.py',214),
  ('CD -> V S VA','CD',3,'p_CD','syntactic_analyzer.py',215),
  ('CD -> VA S V','CD',3,'p_CD','syntactic_analyzer.py',216),
  ('CD -> VA S VA','CD',3,'p_CD','syntactic_analyzer.py',217),
  ('S -> EQUAL','S',1,'p_S','syntactic_analyzer.py',225),
  ('S -> GREATER_THAN','S',1,'p_S','syntactic_analyzer.py',226),
  ('S -> LESS_THAN','S',1,'p_S','syntactic_analyzer.py',227),
  ('S -> GREATER_OR_EQUAL','S',1,'p_S','syntactic_analyzer.py',228),
  ('S -> LESS_OR_EQUAL','S',1,'p_S','syntactic_analyzer.py',229),
  ('S -> NOT_EQUAL','S',1,'p_S','syntactic_analyzer.py',230),
  ('GF -> TD V ME PR MA MY C RT MN BLOCK_CODE','GF',10,'p_GF','syntactic_analyzer.py',238),
  ('GF -> V ME PR MA MY C MN BLOCK_CODE','GF',8,'p_GF','syntactic_analyzer.py',239),
  ('GF -> TD V ME PR MA MY RT MN BLOCK_CODE','GF',9,'p_GF','syntactic_analyzer.py',240),
  ('GF -> V ME PR MA MY MN BLOCK_CODE','GF',7,'p_GF','syntactic_analyzer.py',241),
  ('GF -> TD V ME MA MY C RT MN BLOCK_CODE','GF',9,'p_GF','syntactic_analyzer.py',242),
  ('GF -> V ME MA MY C MN BLOCK_CODE','GF',7,'p_GF','syntactic_analyzer.py',243),
  ('GF -> TD V ME MA MY RT MN BLOCK_CODE','GF',8,'p_GF','syntactic_analyzer.py',244),
  ('GF -> V ME MA MY MN BLOCK_CODE','GF',6,'p_GF','syntactic_analyzer.py',245),
  ('GF -> EMPTY','GF',1,'p_GF','syntactic_analyzer.py',246),
  ('PR -> V','PR',1,'p_PR','syntactic_analyzer.py',265),
  ('ME -> LESS_THAN','ME',1,'p_ME','syntactic_analyzer.py',273),
  ('MA -> GREATER_THAN','MA',1,'p_MA','syntactic_analyzer.py',281),
  ('RT -> RETURN V','RT',2,'p_RT','syntactic_analyzer.py',289),
  ('GCF -> F PA CDF PC MY C MN BLOCK_CODE','GCF',8,'p_GCF','syntactic_analyzer.py',297),
  ('GCF -> F PA CDF PC MY MN BLOCK_CODE','GCF',7,'p_GCF','syntactic_analyzer.py',298),
  ('GCF -> EMPTY','GCF',1,'p_GCF','syntactic_analyzer.py',299),
  ('F -> FOR','F',1,'p_F','syntactic_analyzer.py',312),
  ('CDF -> NUMBER SE NUMBER SE O','CDF',5,'p_CDF','syntactic_analyzer.py',320),
  ('SE -> PIPE','SE',1,'p_PIPE','syntactic_analyzer.py',328),
  ('O -> SUBTRACTION','O',1,'p_O','syntactic_analyzer.py',336),
  ('O -> ADDITION','O',1,'p_O','syntactic_analyzer.py',337),
  ('PA -> PARENTHESIS_OPEN','PA',1,'p_PA','syntactic_analyzer.py',348),
  ('PC -> PARENTHESIS_CLOSE','PC',1,'p_PC','syntactic_analyzer.py',356),
  ('MY -> OPEN_BODY','MY',1,'p_MY','syntactic_analyzer.py',364),
  ('MN -> LESS_OR_EQUAL','MN',1,'p_MN','syntactic_analyzer.py',372),
  ('EMPTY -> <empty>','EMPTY',0,'p_empty','syntactic_analyzer.py',379),
]
